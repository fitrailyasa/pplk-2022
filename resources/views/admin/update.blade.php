...
<section>
    ...
    <!--ITERA-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editupt">
      <div class="card">
      <div class="card-header">
    ...
    <!--Prodi-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editprodi">
      <div class="card">
      <div class="card-header">
    ...
    <!--Himpunan-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="edithimpunan">
      <div class="card">
      <div class="card-header">
    ...
    <!--UKM/Komunitas-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editukm">
      <div class="card">
      <div class="card-header">
    ...
    <!--Funfact-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editfunfact">
      <div class="card">
      <div class="card-header">
    ...
    <!--Begalin-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editbegalin">
      <div class="card">
      <div class="card-header">
    ...
    <!--Kamus Gaul-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editkamus">
      <div class="card">
      <div class="card-header">
    ...
    <!--Games redeem code-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editredeem">
      <div class="card">
        <div class="card-header">
    ...
    <!--Games Tebak-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="edittebak">
      <div class="card">
      <div class="card-header">
    ...
    <!--Booklet-->
    <div class="col-lg-12 col-lg-12 form-wrapper tabcontents" style="display: none"  id="editbooklet">
      <div class="card">
        <div class="card-header">
