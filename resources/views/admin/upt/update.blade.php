...
<div class="col-lg-12 col-lg-12 form-wrapper" id="edit-upt">
    ...
    @if(auth()->user()->roles_id == 1)
        <form method="POST" action="{{ route('super.upt.update',$upt->id) }}" enctype='multipart/form-data'>
    @elseif(auth()->user()->roles_id == 2)
        <form method="POST" action="{{ route('admin.upt.update',$upt->id) }}" enctype='multipart/form-data'>
    @endif
        @csrf
      @method('PUT')
