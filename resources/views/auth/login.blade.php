...
<div class="launch-logo fade" id="splash-screen">
  <img src="{{ asset('assets/logo-pplk-minified.webp') }}" alt="launch-logo-pplk" class="launch-logo-image" />
</div>
    ...
    <div class="container-fluid d-flex justify-content-center mt-3 mb-3">
      ...
      <div class="row justify-content-center">
        <div class="col-sm-6 col-md-5 text-center text-wrap" id="image">
          <img class="img-fluid" src="{{ asset('assets/logo-pplk-minified.webp') }}" alt="logo-pplk-minified" />
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-12 d-flex justify-content-center text-center">
          <p class="text-muted text-size">
            <a href="{{ route('guest') }}" style="text-decoration: none;">Masuk sebagai <strong>Guest</strong></a><br>
