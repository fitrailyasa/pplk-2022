            ...
            <div class="row justify-content-center">
                <div class="col-9">
                    <div class="poin-card bg-white rounded-4 justify-content-center text-center">
                        ...
                        <div class="pesan">
                            <p class="text-danger m-0 text-pesan">yahhh....</p>
                            <p class="jawaban">Jawabanmu Kurang tepat </p>
                        </div>
                    ...
                    <a class="text-decoration-none" href ="{{ url('/card-list') }}" >
                        <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-redeem">SELESAI</button>
                    </div>
                </a>
                <a class="text-decoration-none" href="{{  url('/game-home')}}">
                    <div class="d-flex justify-content-center">
