        ...
        <div class="container-fluid redeem py-3">
            <div class="row justify-content-around">
                <div class="col-11 text-start">
                    <p class="text-white title-text">SCORE TEBAK GAMBAR</p>
                ...
                <div class="col-9">
                    <div class="poin-card bg-white rounded-4 justify-content-center text-center">
                        ...
                        <div class="pesan">
                            ...
                            <p class="jawaban">Kamu Telah Menjawab Seluruh Pertanyaan</p>
                        </div>
                        <div class="row justify-content-center mt-4">
                            <div class="col-6">
                                <p class="fs-4 fw-bold text-kelompok">Kamu mendapat poin</p>

                                <div class="poin-container rounded-circle mx-auto">
                                    <p id="poin">{{ $player->score }}</p>
                    ...
                    <a href ="/tebak-bangunan-selesai/{{ $player->id }}" >
