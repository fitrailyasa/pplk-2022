    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <div class="row justify-content-center pt-5 pb-1">
                ...
                <p class="pt-3 pb-5 row justify-content-center fw-bolder" style="color: white; font-size: 2.5rem;">GAMES</p>
                <div class="row justify-content-center container-started">
                    <a class="btn btn-primary btn-started justify-content-center text-wrap" href="#play-the-game" role="button" style="align-items: center !important;"><small>Get Started!</small></a>
                </div>
            </div>

            <div class="pt-5 row justify-content-center">
                <div class="" id="play-the-game">
                    <p class="play-game text-center">LET'S PLAY THE GAMES</p>
                    <p class="play-game text-center"> ABOUT <a href="#games-bounce" class="play-pplk">PPLK 2022</a></p>
                </div>
                <div class="card card-user-info w-50 rounded-4 pt-3" id="ranking-card">
                    <div class="row p-2">
                        ...
                        <div class="col-auto d-flex">
                            <p style="font-size:1.3rem; text-indent: 10px; color: azure;" class="points-title"><i style="color:yellow" class="fa-solid fa-coins"></i>  11563 Points</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container row justify-content-center pt-4 flex-wrap mx-auto">
                <a class="p-4 text-light col-md-5 card rounded-4 justify-content-start text-decoration-none" href="" id="choose-games">
                    <h2 class="fw-bold">Redeem Code</h2>
